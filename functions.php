...
function university_custom_rest() {
	register_rest_field("post", "authorName", array(
		"get_callback" => function() {return get_the_author();} // it's possibble return any value using wordpress php function
	));

	register_rest_field("note", "userNoteCount", array(
		"get_callback" => function() {return count_user_posts(get_current_user_ID(), "note");} // it's possibble return any value using wordpress php function
	));
}
...
// Redirect subscriber account onto homepage after login
